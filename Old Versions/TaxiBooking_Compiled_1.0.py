...
if option == '1':
    ...
    for j in range(len(header_list)):
        ...
        #Calculate total price prior to manually correcting prices
            #try:
                #calculate_price_list.append(int(wcell2.value))
            #except:
                #calculate_price_list.append(0)
    ...
    try:
        ...
        column_list = ['A','B','C']
        column_list_header = ['Date','Total Trips','Total Price']
        for j in range(len(column_list)):
            c = ws[column_list[j]+str(1)]
            c.fill = PatternFill(patternType='solid',fgColor="5B9BD5") #blue
            c.font = ft
        ...
        print("ERROR! Make sure the name of your sheets are '1','2','3' etc.")
        time.sleep(1)
